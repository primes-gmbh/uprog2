	...
	// FLASH
	.equ	C40ASF_BASE	, 0x402EC000
	.equ	C40ASF_MCR	, 0x00
	.equ	C40ASF_MCRS	, 0x04
	.equ	C40ASF_DATA	, 0x402EC100

	.equ	PFLASH_BASE	, 0x40268000
	.equ	PFLASH_PEADRL	, 0x40268300
	.equ	PFLASH_SPELOCK0		, 0x40
	.equ	PFLASH_SPELOCK1		, 0x44
	.equ	PFLASH_SPELOCK2		, 0x48
	.equ	PFLASH_SPELOCK3		, 0x4C
	.equ	PFLASH_SPELOCK4		, 0x50
	.equ	PFLASH_SPELOCKU		, 0x58
	.equ	PFLASH_SSPELOCK0	, 0x5C
	.equ	PFLASH_SSPELOCK1	, 0x60
	.equ	PFLASH_SSPELOCK2	, 0x64
	.equ	PFLASH_SSPELOCK3	, 0x68
