...
zz1:
			e_lis		r26,SIUL_BASE
			e_lis		r28,MSCR_OUTPUT		#MSCR_OUTPUT
			e_stw		r28,MSCR_I1(r26)	#PI1
			e_stw		r28,MSCR_I2(r26)	#PI2
.endif
...
################################################################################
# 0x19 = erase HSM code flash
################################################################################
hcode_erase:		e_cmp16i	r25,0x19		# data erase
			se_bne		hdata_erase

erase_hcode:		e_li		r31,0x0004
			se_stw		r31,FLASH_MCR(r29)
			e_lis		r31,0x0C20		#low select
			e_stw		r31,FLASH_SEL0(r29)
			e_li		r31,0x0000
			e_stw		r31,FLASH_SEL1(r29)
			e_li		r31,0x0000
			e_stw		r31,FLASH_SEL2(r29)
			e_lis		r31,0x0061		#addr
			se_stw		r31,0(r31)
			e_li		r31,0x0005
			se_stw		r31,FLASH_MCR(r29)
prog_ehf_loop:		se_lwz		r31,FLASH_MCR(r29)
			e_and2i.	r31,0x400
			se_beq		prog_ehf_loop
			e_li		r31,0x0004
			se_stw		r31,FLASH_MCR(r29)
			e_li		r31,0x0000
			se_stw		r31,FLASH_MCR(r29)
...
################################################################################
# 0x1B = erase HSM data flash
################################################################################
hdata_erase:		e_cmp16i	r25,0x1B		# data erase
			se_bne		utest_dword

erase_hdata:		e_li		r31,0x0004
			se_stw		r31,FLASH_MCR(r29)
			e_li		r31,0x0003		#mid select
			e_stw		r31,FLASH_SEL0(r29)
			e_li		r31,0x0000
			e_stw		r31,FLASH_SEL1(r29)
			e_li		r31,0x0000
			e_stw		r31,FLASH_SEL2(r29)
			e_lis		r31,0x0068		#addr
			se_stw		r31,0(r31)
			e_li		r31,0x0005
			se_stw		r31,FLASH_MCR(r29)
prog_ehd_loop:		se_lwz		r31,FLASH_MCR(r29)
			e_and2i.	r31,0x400
			se_beq		prog_ehd_loop
			e_li		r31,0x0004
			se_stw		r31,FLASH_MCR(r29)
			e_li		r31,0x0000
			se_stw		r31,FLASH_MCR(r29)
